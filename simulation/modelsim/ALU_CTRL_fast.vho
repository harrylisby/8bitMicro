...
SIGNAL \IR[0]~0clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \carryOut~0clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \XALU|Mux9~7_combout\ : std_logic;
...
SIGNAL \prox_estado.progMemRead_590~combout\ : std_logic;
SIGNAL \estado.progMemRead~0_combout\ : std_logic;
SIGNAL \estado.progMemRead~regout\ : std_logic;
SIGNAL \prox_estado.moveToRegisters_584~combout\ : std_logic;
...
SIGNAL \IR[0]~0clkctrl_outclk\ : std_logic;
...
SIGNAL \XALU|Add4~0_combout\ : std_logic;
SIGNAL \XALU|Add1~0_combout\ : std_logic;
SIGNAL \XALU|Mux9~8_combout\ : std_logic;
SIGNAL \XALU|Mux9~9_combout\ : std_logic;
SIGNAL \XALU|Add0~0_combout\ : std_logic;
SIGNAL \XALU|Mux9~10_combout\ : std_logic;
SIGNAL \XROM|Mux3~0_combout\ : std_logic;
SIGNAL \XALU|Mux9~11_combout\ : std_logic;
SIGNAL \XALU|Mux9~12_combout\ : std_logic;
...
SIGNAL \XALU|Mux7~7_combout\ : std_logic;
SIGNAL \prox_estado.resultToW_578~combout\ : std_logic;
...
SIGNAL \XALU|Mux9~13_combout\ : std_logic;
...
SIGNAL \XALU|Mux6~7_combout\ : std_logic;
...
SIGNAL \XALU|Mux4~7_combout\ : std_logic;
...
SIGNAL \XALU|Mux3~7_combout\ : std_logic;
SIGNAL \XALU|Mux3~8_combout\ : std_logic;
SIGNAL \XALU|Mux3~9_combout\ : std_logic;
...
SIGNAL \XALU|Mux2~10_combout\ : std_logic;
SIGNAL \XALU|Mux10~1_combout\ : std_logic;
SIGNAL \XALU|Mux0~1_combout\ : std_logic;
...
SIGNAL \carryOut~0clkctrl_outclk\ : std_logic;
SIGNAL \carryOut$latch~combout\ : std_logic;
...
\IR[0]~0clkctrl_INCLK_bus\ <= (gnd & gnd & gnd & \IR[0]~0_combout\);
...
\carryOut~0clkctrl_INCLK_bus\ <= (gnd & gnd & gnd & \carryOut~0_combout\);
...
-- Equation(s):
-- \XALU|Add2~0_combout\ = (regW(0) & (regB(1) $ (VCC))) # (!regW(0) & (regB(1) & VCC))
-- \XALU|Add2~1\ = CARRY((regW(0) & regB(1)))
...
-- Equation(s):
-- \XALU|Add4~2_combout\ = (regW(1) & ((regB(1) & (!\XALU|Add4~1\)) # (!regB(1) & (\XALU|Add4~1\ & VCC)))) # (!regW(1) & ((regB(1) & ((\XALU|Add4~1\) # (GND))) # (!regB(1) & (!\XALU|Add4~1\))))
-- \XALU|Add4~3\ = CARRY((regW(1) & (regB(1) & !\XALU|Add4~1\)) # (!regW(1) & ((regB(1)) # (!\XALU|Add4~1\))))
...
-- Equation(s):
-- \XALU|Add4~4_combout\ = ((regW(2) $ (regB(2) $ (\XALU|Add4~3\)))) # (GND)
-- \XALU|Add4~5\ = CARRY((regW(2) & ((!\XALU|Add4~3\) # (!regB(2)))) # (!regW(2) & (!regB(2) & !\XALU|Add4~3\)))
...
-- Equation(s):
-- \XALU|Add4~6_combout\ = (regW(3) & ((regB(3) & (!\XALU|Add4~5\)) # (!regB(3) & (\XALU|Add4~5\ & VCC)))) # (!regW(3) & ((regB(3) & ((\XALU|Add4~5\) # (GND))) # (!regB(3) & (!\XALU|Add4~5\))))
-- \XALU|Add4~7\ = CARRY((regW(3) & (regB(3) & !\XALU|Add4~5\)) # (!regW(3) & ((regB(3)) # (!\XALU|Add4~5\))))
...
-- Equation(s):
-- \XALU|Add2~8_combout\ = ((regB(4) $ (regW(4) $ (!\XALU|Add2~7\)))) # (GND)
-- \XALU|Add2~9\ = CARRY((regB(4) & ((regW(4)) # (!\XALU|Add2~7\))) # (!regB(4) & (regW(4) & !\XALU|Add2~7\)))
...
-- Equation(s):
-- \XALU|Add4~8_combout\ = ((regW(4) $ (regB(4) $ (\XALU|Add4~7\)))) # (GND)
-- \XALU|Add4~9\ = CARRY((regW(4) & ((!\XALU|Add4~7\) # (!regB(4)))) # (!regW(4) & (!regB(4) & !\XALU|Add4~7\)))
...
-- Equation(s):
-- \XALU|Add4~12_combout\ = ((regB(6) $ (regW(6) $ (\XALU|Add4~11\)))) # (GND)
-- \XALU|Add4~13\ = CARRY((regB(6) & (regW(6) & !\XALU|Add4~11\)) # (!regB(6) & ((regW(6)) # (!\XALU|Add4~11\))))
...
-- Equation(s):
-- \XALU|Mux0~0_combout\ = (!regOp(3) & !regOp(2))
...
-- Equation(s):
-- \XALU|Mux9~4_combout\ = (!regOp(1) & ((regOp(0) & (regB(1))) # (!regOp(0) & ((regW(0))))))
...
-- Equation(s):
-- \XALU|Mux9~5_combout\ = (!regOp(0) & (regOp(2) & ((regOp(1)) # (regOp(3)))))
...
-- Equation(s):
-- \XALU|Mux9~6_combout\ = (\XALU|Add2~0_combout\ & ((\XALU|Mux9~5_combout\) # ((\XALU|Mux9~3_combout\ & \XALU|Mux9~4_combout\)))) # (!\XALU|Add2~0_combout\ & (\XALU|Mux9~3_combout\ & (\XALU|Mux9~4_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \XALU|Add2~0_combout\,
	datab => \XALU|Mux9~3_combout\,
	datac => \XALU|Mux9~4_combout\,
	datad => \XALU|Mux9~5_combout\,
	combout => \XALU|Mux9~6_combout\);

-- Location: LCCOMB_X38_Y11_N6
\XALU|Mux9~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux9~7_combout\ = (regOp(2) & (!regW(0) & ((regB(1)) # (regOp(1)))))
...
PORT MAP (
	...
	datac => regB(1),
	datad => regOp(1),
	combout => \XALU|Mux9~7_combout\);

-- Location: LCCOMB_X36_Y11_N8
\XALU|Mux5~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux5~0_combout\ = (regOp(0) & ((regW(5)))) # (!regOp(0) & (regW(3)))
...
-- Equation(s):
-- \XALU|Mux5~1_combout\ = (regOp(1) & ((regOp(2) & ((regOp(3)))) # (!regOp(2) & (\XALU|Mux5~0_combout\ & !regOp(3)))))
...
-- Equation(s):
-- \XALU|Mux5~2_combout\ = (regOp(0) & ((regB(4)) # ((regOp(1))))) # (!regOp(0) & (((!regOp(1) & regW(4)))))
...
-- Equation(s):
-- \XALU|Mux5~3_combout\ = (regOp(1) & ((\XALU|Mux5~2_combout\ & (\XALU|Add1~8_combout\)) # (!\XALU|Mux5~2_combout\ & ((\XALU|Add0~8_combout\))))) # (!regOp(1) & (((\XALU|Mux5~2_combout\))))
...
PORT MAP (
	dataa => regOp(1),
	datab => \XALU|Add1~8_combout\,
	datac => \XALU|Mux5~2_combout\,
	datad => \XALU|Add0~8_combout\,
	combout => \XALU|Mux5~3_combout\);

-- Location: LCCOMB_X36_Y11_N10
\XALU|Mux5~4\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux5~4_combout\ = (regW(4) & (regOp(1) $ (((regOp(0)) # (regB(4)))))) # (!regW(4) & ((regOp(0) & ((regOp(1)) # (regB(4)))) # (!regOp(0) & (regOp(1) & regB(4)))))
...
-- Equation(s):
-- \XALU|Mux5~5_combout\ = (\XALU|Mux3~0_combout\ & ((\XALU|Mux3~1_combout\) # ((\XALU|Add2~8_combout\)))) # (!\XALU|Mux3~0_combout\ & (!\XALU|Mux3~1_combout\ & ((\XALU|Mux5~4_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \XALU|Mux3~0_combout\,
	datab => \XALU|Mux3~1_combout\,
...
-- Equation(s):
-- \XALU|Mux5~6_combout\ = (\XALU|Mux3~1_combout\ & ((\XALU|Mux5~5_combout\ & (\XALU|Add4~8_combout\)) # (!\XALU|Mux5~5_combout\ & ((\XALU|Mux5~3_combout\))))) # (!\XALU|Mux3~1_combout\ & (((\XALU|Mux5~5_combout\))))
...
-- Equation(s):
-- \XALU|Mux5~7_combout\ = (\XALU|Mux5~1_combout\) # ((\XALU|Mux5~6_combout\ & ((regOp(3)) # (regOp(2)))))
...
-- Equation(s):
-- \XROM|Mux0~0_combout\ = (regAddress(2) & ((regAddress(3)) # ((!regAddress(0) & !regAddress(1))))) # (!regAddress(2) & ((regAddress(1) & ((regAddress(0)) # (!regAddress(3)))) # (!regAddress(1) & ((regAddress(3))))))
...
-- Equation(s):
-- \XROM|Mux2~0_combout\ = (!regAddress(2) & (regAddress(0) & (regAddress(1) & !regAddress(3))))
...
-- Equation(s):
-- \XROM|Mux1~0_combout\ = (regAddress(3) & (((!regAddress(1) & !regAddress(2))))) # (!regAddress(3) & ((regAddress(0)) # ((regAddress(1)) # (regAddress(2)))))
...
-- Equation(s):
-- IR(11) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & (!\XROM|Mux0~0_combout\)) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & ((IR(11))))
...
\prox_estado.progMemRead_590\ : cycloneii_lcell_comb
-- Equation(s):
-- \prox_estado.progMemRead_590~combout\ = (\rst~combout\ & (\estado.resultToW~regout\)) # (!\rst~combout\ & ((\prox_estado.progMemRead_590~combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \estado.resultToW~regout\,
	datac => \rst~combout\,
	datad => \prox_estado.progMemRead_590~combout\,
	combout => \prox_estado.progMemRead_590~combout\);

-- Location: LCCOMB_X36_Y13_N18
\estado.progMemRead~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \estado.progMemRead~0_combout\ = !\prox_estado.progMemRead_590~combout\
...
\prox_estado.moveToRegisters_584\ : cycloneii_lcell_comb
-- Equation(s):
-- \prox_estado.moveToRegisters_584~combout\ = (\rst~combout\ & ((!\estado.progMemRead~regout\))) # (!\rst~combout\ & (\prox_estado.moveToRegisters_584~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \prox_estado.moveToRegisters_584~combout\,
	datac => \rst~combout\,
	datad => \estado.progMemRead~regout\,
	combout => \prox_estado.moveToRegisters_584~combout\);

-- Location: LCFF_X36_Y13_N23
\estado.moveToRegisters\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ALT_INV_clk~combout\,
	datain => \prox_estado.moveToRegisters_584~combout\,
	aclr => \ALT_INV_rst~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \regW[6]~0_combout\ = (\rst~combout\ & \estado.moveToRegisters~regout\)
...
\IR[0]~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \IR[0]~0_combout\ = (!\estado.progMemRead~regout\ & \rst~combout\)
...
-- pragma translate_on
PORT MAP (
	datac => \estado.progMemRead~regout\,
	datad => \rst~combout\,
	combout => \IR[0]~0_combout\);

-- Location: CLKCTRL_G6
\IR[0]~0clkctrl\ : cycloneii_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
-- pragma translate_on
PORT MAP (
	inclk => \IR[0]~0clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \IR[0]~0clkctrl_outclk\);

-- Location: LCCOMB_X38_Y14_N8
\IR[10]\ : cycloneii_lcell_comb
-- Equation(s):
-- IR(10) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & (\XROM|Mux1~0_combout\)) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & ((IR(10))))
...
-- Equation(s):
-- \XALU|Mux3~0_combout\ = (regOp(2) & regOp(3))
...
PORT MAP (
	...
	datab => \rst~combout\,
	datac => PC(0),
	datad => \estado.moveToRegisters~clkctrl_outclk\,
	combout => PC(0));

-- Location: LCCOMB_X49_Y10_N22
\regAddress[0]\ : cycloneii_lcell_comb
-- Equation(s):
-- regAddress(0) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & ((PC(0)))) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & (regAddress(0)))
...
-- Equation(s):
-- regAddress(1) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & ((PC(1)))) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & (regAddress(1)))
...
-- Equation(s):
-- regAddress(2) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & ((PC(2)))) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & (regAddress(2)))
...
-- Equation(s):
-- \Add0~2_combout\ = regAddress(3) $ (((regAddress(2) & (regAddress(1) & regAddress(0)))))
...
-- Equation(s):
-- regAddress(3) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & ((PC(3)))) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & (regAddress(3)))
...
-- Equation(s):
-- \XROM|Mux10~0_combout\ = (regAddress(1) & ((regAddress(2)) # (regAddress(0) $ (!regAddress(3))))) # (!regAddress(1) & ((regAddress(0)) # ((regAddress(3)))))
...
-- Equation(s):
-- IR(1) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & (!\XROM|Mux10~0_combout\)) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & ((IR(1))))
...
\XALU|Add4~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Add4~0_combout\ = (regW(0) & (regB(1) $ (GND))) # (!regW(0) & (!regB(1) & VCC))
-- \XALU|Add4~1\ = CARRY((regW(0) & !regB(1)))
...
PORT MAP (
	...
	datab => regB(1),
	datad => VCC,
	combout => \XALU|Add4~0_combout\,
	cout => \XALU|Add4~1\);

-- Location: LCCOMB_X37_Y14_N16
\IR[9]\ : cycloneii_lcell_comb
-- Equation(s):
-- IR(9) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & (\XROM|Mux2~0_combout\)) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & ((IR(9))))
...
\XALU|Mux9~8\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux9~8_combout\ = (regOp(3) & (regOp(1) & ((\XALU|Mux9~7_combout\) # (\XALU|Add1~0_combout\)))) # (!regOp(3) & (\XALU|Mux9~7_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \XALU|Mux9~7_combout\,
	datab => regOp(3),
	datac => regOp(1),
	datad => \XALU|Add1~0_combout\,
	combout => \XALU|Mux9~8_combout\);

-- Location: LCCOMB_X38_Y11_N18
\XALU|Mux9~9\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux9~9_combout\ = (regOp(0) & ((\XALU|Mux9~8_combout\) # ((\XALU|Mux3~0_combout\ & \XALU|Add4~0_combout\))))
...
PORT MAP (
	dataa => regOp(0),
	datab => \XALU|Mux3~0_combout\,
	datac => \XALU|Add4~0_combout\,
	datad => \XALU|Mux9~8_combout\,
	combout => \XALU|Mux9~9_combout\);
...
\XALU|Mux9~10\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux9~10_combout\ = (regOp(2) & (regOp(3) & regOp(1)))
...
-- Equation(s):
-- IR(8) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & (!\XROM|Mux3~0_combout\)) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & ((IR(8))))
...
\XALU|Mux9~11\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux9~11_combout\ = (!regOp(0) & regOp(1))
...
PORT MAP (
	datac => regOp(0),
	datad => regOp(1),
	combout => \XALU|Mux9~11_combout\);

-- Location: LCCOMB_X36_Y12_N18
\XALU|Mux9~12\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux9~12_combout\ = (\XALU|Mux9~10_combout\) # ((regOp(3) & (\XALU|Add0~0_combout\ & \XALU|Mux9~11_combout\)))
...
PORT MAP (
	...
	datac => \XALU|Mux9~10_combout\,
	datad => \XALU|Mux9~11_combout\,
	combout => \XALU|Mux9~12_combout\);

-- Location: LCCOMB_X38_Y13_N0
\XALU|Mux9~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux9~1_combout\ = (regOp(2) & (regW(0) & ((regOp(0)) # (regB(1)))))
...
-- Equation(s):
-- \XALU|Mux7~0_combout\ = (regOp(0) & (regW(3))) # (!regOp(0) & ((regW(1))))
...
-- Equation(s):
-- \XALU|Mux7~1_combout\ = (regOp(1) & ((regOp(3) & (regOp(2))) # (!regOp(3) & (!regOp(2) & \XALU|Mux7~0_combout\))))
...
-- Equation(s):
-- IR(2) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & (!\XROM|Mux9~0_combout\)) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & ((IR(2))))
...
-- Equation(s):
-- \XALU|Mux7~4_combout\ = (regW(2) & (regOp(1) $ (((regOp(0)) # (regB(2)))))) # (!regW(2) & ((regOp(0) & ((regOp(1)) # (regB(2)))) # (!regOp(0) & (regOp(1) & regB(2)))))
...
-- Equation(s):
-- \XALU|Add2~2_combout\ = (regB(1) & ((regW(1) & (\XALU|Add2~1\ & VCC)) # (!regW(1) & (!\XALU|Add2~1\)))) # (!regB(1) & ((regW(1) & (!\XALU|Add2~1\)) # (!regW(1) & ((\XALU|Add2~1\) # (GND)))))
-- \XALU|Add2~3\ = CARRY((regB(1) & (!regW(1) & !\XALU|Add2~1\)) # (!regB(1) & ((!\XALU|Add2~1\) # (!regW(1)))))
...
-- Equation(s):
-- \XALU|Add2~4_combout\ = ((regB(2) $ (regW(2) $ (!\XALU|Add2~3\)))) # (GND)
-- \XALU|Add2~5\ = CARRY((regB(2) & ((regW(2)) # (!\XALU|Add2~3\))) # (!regB(2) & (regW(2) & !\XALU|Add2~3\)))
...
-- Equation(s):
-- \XALU|Mux7~5_combout\ = (\XALU|Mux3~0_combout\ & ((\XALU|Mux3~1_combout\) # ((\XALU|Add2~4_combout\)))) # (!\XALU|Mux3~0_combout\ & (!\XALU|Mux3~1_combout\ & (\XALU|Mux7~4_combout\)))
...
PORT MAP (
	dataa => \XALU|Mux3~0_combout\,
	datab => \XALU|Mux3~1_combout\,
	datac => \XALU|Mux7~4_combout\,
	datad => \XALU|Add2~4_combout\,
	combout => \XALU|Mux7~5_combout\);

-- Location: LCCOMB_X36_Y11_N2
\XALU|Mux7~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux7~2_combout\ = (regOp(0) & ((regB(2)) # ((regOp(1))))) # (!regOp(0) & (((!regOp(1) & regW(2)))))
...
-- Equation(s):
-- \XALU|Mux7~3_combout\ = (regOp(1) & ((\XALU|Mux7~2_combout\ & (\XALU|Add1~4_combout\)) # (!\XALU|Mux7~2_combout\ & ((\XALU|Add0~4_combout\))))) # (!regOp(1) & (\XALU|Mux7~2_combout\))
...
-- Equation(s):
-- \XALU|Mux7~6_combout\ = (\XALU|Mux3~1_combout\ & ((\XALU|Mux7~5_combout\ & (\XALU|Add4~4_combout\)) # (!\XALU|Mux7~5_combout\ & ((\XALU|Mux7~3_combout\))))) # (!\XALU|Mux3~1_combout\ & (((\XALU|Mux7~5_combout\))))
...
PORT MAP (
	...
	datab => \XALU|Mux3~1_combout\,
	datac => \XALU|Mux7~5_combout\,
	datad => \XALU|Mux7~3_combout\,
	combout => \XALU|Mux7~6_combout\);

-- Location: LCCOMB_X36_Y11_N28
\XALU|Mux7~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux7~7_combout\ = (\XALU|Mux7~1_combout\) # ((\XALU|Mux7~6_combout\ & ((regOp(3)) # (regOp(2)))))
...
PORT MAP (
	...
	combout => \XALU|Mux7~7_combout\);

-- Location: LCCOMB_X36_Y13_N12
\prox_estado.resultToW_578\ : cycloneii_lcell_comb
-- Equation(s):
-- \prox_estado.resultToW_578~combout\ = (\rst~combout\ & (\estado.moveToRegisters~regout\)) # (!\rst~combout\ & ((\prox_estado.resultToW_578~combout\)))
...
PORT MAP (
	...
	datac => \rst~combout\,
	datad => \prox_estado.resultToW_578~combout\,
	combout => \prox_estado.resultToW_578~combout\);

-- Location: LCFF_X36_Y13_N13
\estado.resultToW\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ALT_INV_clk~combout\,
	datain => \prox_estado.resultToW_578~combout\,
	aclr => \ALT_INV_rst~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- W(2) = (\rst~combout\ & ((GLOBAL(\estado.resultToW~clkctrl_outclk\) & ((\XALU|Mux7~7_combout\))) # (!GLOBAL(\estado.resultToW~clkctrl_outclk\) & (W(2)))))
...
-- Equation(s):
-- \XALU|Mux8~0_combout\ = (regOp(0) & (regW(2))) # (!regOp(0) & ((regW(0))))
...
-- Equation(s):
-- \XALU|Mux8~1_combout\ = (regOp(1) & ((regOp(2) & ((regOp(3)))) # (!regOp(2) & (\XALU|Mux8~0_combout\ & !regOp(3)))))
...
-- Equation(s):
-- \XALU|Mux8~4_combout\ = (regW(1) & (regOp(1) $ (((regB(1)) # (regOp(0)))))) # (!regW(1) & ((regB(1) & ((regOp(1)) # (regOp(0)))) # (!regB(1) & (regOp(1) & regOp(0)))))
...
-- Equation(s):
-- \XALU|Mux8~5_combout\ = (\XALU|Mux3~0_combout\ & ((\XALU|Mux3~1_combout\) # ((\XALU|Add2~2_combout\)))) # (!\XALU|Mux3~0_combout\ & (!\XALU|Mux3~1_combout\ & ((\XALU|Mux8~4_combout\))))
...
-- Equation(s):
-- \XALU|Mux8~2_combout\ = (regOp(1) & (((regOp(0))))) # (!regOp(1) & ((regOp(0) & (regB(1))) # (!regOp(0) & ((regW(1))))))
...
PORT MAP (
	dataa => regOp(1),
	datab => \XALU|Add0~2_combout\,
	datac => \XALU|Add1~2_combout\,
	datad => \XALU|Mux8~2_combout\,
	combout => \XALU|Mux8~3_combout\);

-- Location: LCCOMB_X37_Y10_N0
\XALU|Mux8~6\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux8~6_combout\ = (\XALU|Mux3~1_combout\ & ((\XALU|Mux8~5_combout\ & (\XALU|Add4~2_combout\)) # (!\XALU|Mux8~5_combout\ & ((\XALU|Mux8~3_combout\))))) # (!\XALU|Mux3~1_combout\ & (((\XALU|Mux8~5_combout\))))
...
PORT MAP (
	...
	datad => \XALU|Mux8~3_combout\,
	combout => \XALU|Mux8~6_combout\);

-- Location: LCCOMB_X37_Y10_N22
\XALU|Mux8~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux8~7_combout\ = (\XALU|Mux8~1_combout\) # ((\XALU|Mux8~6_combout\ & ((regOp(3)) # (regOp(2)))))
...
-- Equation(s):
-- \XALU|Mux9~0_combout\ = (!regOp(2) & (regW(1) & (regOp(0) & regOp(1))))
...
-- Equation(s):
-- \XALU|Mux9~2_combout\ = (!regOp(3) & ((\XALU|Mux9~0_combout\) # ((!regOp(1) & \XALU|Mux9~1_combout\))))
...
\XALU|Mux9~13\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux9~13_combout\ = (\XALU|Mux9~6_combout\) # ((\XALU|Mux9~9_combout\) # ((\XALU|Mux9~12_combout\) # (\XALU|Mux9~2_combout\)))
...
PORT MAP (
	...
	datab => \XALU|Mux9~9_combout\,
	datac => \XALU|Mux9~12_combout\,
	datad => \XALU|Mux9~2_combout\,
	combout => \XALU|Mux9~13_combout\);

-- Location: LCCOMB_X38_Y11_N0
\W[0]\ : cycloneii_lcell_comb
-- Equation(s):
-- W(0) = (\rst~combout\ & ((GLOBAL(\estado.resultToW~clkctrl_outclk\) & ((\XALU|Mux9~13_combout\))) # (!GLOBAL(\estado.resultToW~clkctrl_outclk\) & (W(0)))))
...
-- Equation(s):
-- \XALU|Mux9~3_combout\ = (regOp(3) & !regOp(2))
...
-- Equation(s):
-- \XROM|Mux4~0_combout\ = (!regAddress(0) & (!regAddress(3) & ((regAddress(2)) # (regAddress(1)))))
...
-- Equation(s):
-- IR(7) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & ((\XROM|Mux4~0_combout\))) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & (IR(7)))
...
-- Equation(s):
-- \XALU|Mux2~0_combout\ = (regOp(2) & (!regOp(3) & (regOp(0) & regB(7))))
...
-- Equation(s):
-- \XALU|Mux2~1_combout\ = (regOp(0) & ((regB(7)))) # (!regOp(0) & (regW(7)))
...
-- Equation(s):
-- \XALU|Mux2~2_combout\ = (!regOp(1) & ((\XALU|Mux2~0_combout\) # ((\XALU|Mux9~3_combout\ & \XALU|Mux2~1_combout\))))
...
PORT MAP (
	...
	datad => \XALU|Mux2~1_combout\,
	combout => \XALU|Mux2~2_combout\);

-- Location: LCCOMB_X38_Y11_N10
\XALU|Mux2~8\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux2~8_combout\ = (regOp(2) & ((regOp(1) & ((!regW(7)))) # (!regOp(1) & (!regOp(3) & regW(7)))))
...
-- Equation(s):
-- \XROM|Mux5~0_combout\ = (!regAddress(3) & ((regAddress(2)) # ((!regAddress(0) & regAddress(1)))))
...
-- Equation(s):
-- IR(6) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & ((\XROM|Mux5~0_combout\))) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & (IR(6)))
...
-- Equation(s):
-- \XROM|Mux6~0_combout\ = (!regAddress(3) & (regAddress(2) $ (((!regAddress(0) & regAddress(1))))))
...
-- Equation(s):
-- IR(5) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & ((\XROM|Mux6~0_combout\))) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & (IR(5)))
...
-- Equation(s):
-- \XROM|Mux8~0_combout\ = (regAddress(2) & ((regAddress(0)) # ((regAddress(3))))) # (!regAddress(2) & ((regAddress(1)) # ((regAddress(0) & regAddress(3)))))
...
-- Equation(s):
-- IR(3) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & ((!\XROM|Mux8~0_combout\))) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & (IR(3)))
...
-- Equation(s):
-- \XALU|Add2~6_combout\ = (regW(3) & ((regB(3) & (\XALU|Add2~5\ & VCC)) # (!regB(3) & (!\XALU|Add2~5\)))) # (!regW(3) & ((regB(3) & (!\XALU|Add2~5\)) # (!regB(3) & ((\XALU|Add2~5\) # (GND)))))
-- \XALU|Add2~7\ = CARRY((regW(3) & (!regB(3) & !\XALU|Add2~5\)) # (!regW(3) & ((!\XALU|Add2~5\) # (!regB(3)))))
...
-- Equation(s):
-- \XALU|Add2~10_combout\ = (regW(5) & ((regB(5) & (\XALU|Add2~9\ & VCC)) # (!regB(5) & (!\XALU|Add2~9\)))) # (!regW(5) & ((regB(5) & (!\XALU|Add2~9\)) # (!regB(5) & ((\XALU|Add2~9\) # (GND)))))
-- \XALU|Add2~11\ = CARRY((regW(5) & (!regB(5) & !\XALU|Add2~9\)) # (!regW(5) & ((!\XALU|Add2~9\) # (!regB(5)))))
...
-- Equation(s):
-- \XALU|Add2~12_combout\ = ((regW(6) $ (regB(6) $ (!\XALU|Add2~11\)))) # (GND)
-- \XALU|Add2~13\ = CARRY((regW(6) & ((regB(6)) # (!\XALU|Add2~11\))) # (!regW(6) & (regB(6) & !\XALU|Add2~11\)))
...
-- Equation(s):
-- \XALU|Add2~14_combout\ = regB(7) $ (\XALU|Add2~13\ $ (regW(7)))
...
-- Equation(s):
-- \XALU|Mux4~0_combout\ = (regOp(0) & (regW(6))) # (!regOp(0) & ((regW(4))))
...
-- Equation(s):
-- \XALU|Mux4~1_combout\ = (regOp(1) & ((regOp(3) & (regOp(2))) # (!regOp(3) & (!regOp(2) & \XALU|Mux4~0_combout\))))
...
PORT MAP (
	...
	datab => regOp(2),
	datac => regOp(1),
	datad => \XALU|Mux4~0_combout\,
	combout => \XALU|Mux4~1_combout\);

-- Location: LCCOMB_X37_Y14_N0
\XROM|Mux7~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \XROM|Mux7~0_combout\ = (!regAddress(0) & ((regAddress(2) & (!regAddress(1) & !regAddress(3))) # (!regAddress(2) & (regAddress(1)))))
...
-- Equation(s):
-- IR(4) = (GLOBAL(\IR[0]~0clkctrl_outclk\) & (\XROM|Mux7~0_combout\)) # (!GLOBAL(\IR[0]~0clkctrl_outclk\) & ((IR(4))))
...
-- Equation(s):
-- \XALU|Add4~10_combout\ = (regW(5) & ((regB(5) & (!\XALU|Add4~9\)) # (!regB(5) & (\XALU|Add4~9\ & VCC)))) # (!regW(5) & ((regB(5) & ((\XALU|Add4~9\) # (GND))) # (!regB(5) & (!\XALU|Add4~9\))))
-- \XALU|Add4~11\ = CARRY((regW(5) & (regB(5) & !\XALU|Add4~9\)) # (!regW(5) & ((regB(5)) # (!\XALU|Add4~9\))))
...
-- Equation(s):
-- \XALU|Mux4~4_combout\ = (regW(5) & (regOp(1) $ (((regOp(0)) # (regB(5)))))) # (!regW(5) & ((regOp(0) & ((regOp(1)) # (regB(5)))) # (!regOp(0) & (regOp(1) & regB(5)))))
...
-- Equation(s):
-- \XALU|Mux4~2_combout\ = (regOp(0) & (((regOp(1)) # (regB(5))))) # (!regOp(0) & (regW(5) & (!regOp(1))))
...
-- Equation(s):
-- \XALU|Mux6~0_combout\ = (regOp(0) & ((regW(4)))) # (!regOp(0) & (regW(2)))
...
-- Equation(s):
-- \XALU|Mux6~1_combout\ = (regOp(1) & ((regOp(2) & (regOp(3))) # (!regOp(2) & (!regOp(3) & \XALU|Mux6~0_combout\))))
...
-- Equation(s):
-- \XALU|Mux6~2_combout\ = (regOp(0) & ((regB(3)) # ((regOp(1))))) # (!regOp(0) & (((regW(3) & !regOp(1)))))
...
-- Equation(s):
-- \XALU|Mux6~3_combout\ = (regOp(1) & ((\XALU|Mux6~2_combout\ & ((\XALU|Add1~6_combout\))) # (!\XALU|Mux6~2_combout\ & (\XALU|Add0~6_combout\)))) # (!regOp(1) & (((\XALU|Mux6~2_combout\))))
...
-- Equation(s):
-- \XALU|Mux6~4_combout\ = (regW(3) & (regOp(1) $ (((regB(3)) # (regOp(0)))))) # (!regW(3) & ((regB(3) & ((regOp(1)) # (regOp(0)))) # (!regB(3) & (regOp(1) & regOp(0)))))
...
-- Equation(s):
-- \XALU|Mux6~5_combout\ = (\XALU|Mux3~1_combout\ & ((\XALU|Mux3~0_combout\) # ((\XALU|Mux6~3_combout\)))) # (!\XALU|Mux3~1_combout\ & (!\XALU|Mux3~0_combout\ & ((\XALU|Mux6~4_combout\))))
...
-- Equation(s):
-- \XALU|Mux6~6_combout\ = (\XALU|Mux3~0_combout\ & ((\XALU|Mux6~5_combout\ & (\XALU|Add4~6_combout\)) # (!\XALU|Mux6~5_combout\ & ((\XALU|Add2~6_combout\))))) # (!\XALU|Mux3~0_combout\ & (((\XALU|Mux6~5_combout\))))
...
\XALU|Mux6~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux6~7_combout\ = (\XALU|Mux6~1_combout\) # ((\XALU|Mux6~6_combout\ & ((regOp(3)) # (regOp(2)))))
...
PORT MAP (
	dataa => regOp(3),
	datab => regOp(2),
	datac => \XALU|Mux6~1_combout\,
	datad => \XALU|Mux6~6_combout\,
	combout => \XALU|Mux6~7_combout\);

-- Location: LCCOMB_X37_Y12_N22
\W[3]\ : cycloneii_lcell_comb
-- Equation(s):
-- W(3) = (\rst~combout\ & ((GLOBAL(\estado.resultToW~clkctrl_outclk\) & ((\XALU|Mux6~7_combout\))) # (!GLOBAL(\estado.resultToW~clkctrl_outclk\) & (W(3)))))
...
-- Equation(s):
-- \XALU|Mux4~3_combout\ = (regOp(1) & ((\XALU|Mux4~2_combout\ & ((\XALU|Add1~10_combout\))) # (!\XALU|Mux4~2_combout\ & (\XALU|Add0~10_combout\)))) # (!regOp(1) & (\XALU|Mux4~2_combout\))
...
PORT MAP (
	dataa => regOp(1),
	datab => \XALU|Mux4~2_combout\,
	datac => \XALU|Add0~10_combout\,
	datad => \XALU|Add1~10_combout\,
	combout => \XALU|Mux4~3_combout\);

-- Location: LCCOMB_X37_Y11_N12
\XALU|Mux4~5\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux4~5_combout\ = (\XALU|Mux3~0_combout\ & (((\XALU|Mux3~1_combout\)))) # (!\XALU|Mux3~0_combout\ & ((\XALU|Mux3~1_combout\ & ((\XALU|Mux4~3_combout\))) # (!\XALU|Mux3~1_combout\ & (\XALU|Mux4~4_combout\))))
...
PORT MAP (
	...
	datad => \XALU|Mux4~3_combout\,
	combout => \XALU|Mux4~5_combout\);

-- Location: LCCOMB_X37_Y11_N30
\XALU|Mux4~6\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux4~6_combout\ = (\XALU|Mux3~0_combout\ & ((\XALU|Mux4~5_combout\ & (\XALU|Add4~10_combout\)) # (!\XALU|Mux4~5_combout\ & ((\XALU|Add2~10_combout\))))) # (!\XALU|Mux3~0_combout\ & (((\XALU|Mux4~5_combout\))))
...
\XALU|Mux4~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux4~7_combout\ = (\XALU|Mux4~1_combout\) # ((\XALU|Mux4~6_combout\ & ((regOp(3)) # (regOp(2)))))
...
PORT MAP (
	dataa => regOp(3),
	datab => \XALU|Mux4~1_combout\,
	datac => regOp(2),
	datad => \XALU|Mux4~6_combout\,
	combout => \XALU|Mux4~7_combout\);

-- Location: LCCOMB_X37_Y11_N18
\W[5]\ : cycloneii_lcell_comb
-- Equation(s):
-- W(5) = (\rst~combout\ & ((GLOBAL(\estado.resultToW~clkctrl_outclk\) & ((\XALU|Mux4~7_combout\))) # (!GLOBAL(\estado.resultToW~clkctrl_outclk\) & (W(5)))))
...
-- Equation(s):
-- \XALU|Mux3~2_combout\ = (regOp(0) & ((regW(7)))) # (!regOp(0) & (regW(5)))
...
-- Equation(s):
-- \XALU|Mux3~3_combout\ = (regOp(1) & ((regOp(3) & (regOp(2))) # (!regOp(3) & (!regOp(2) & \XALU|Mux3~2_combout\))))
...
-- Equation(s):
-- \XALU|Mux3~4_combout\ = (regOp(0) & (((regB(6)) # (regOp(1))))) # (!regOp(0) & (regW(6) & ((!regOp(1)))))
...
-- Equation(s):
-- \XALU|Mux3~5_combout\ = (regOp(1) & ((\XALU|Mux3~4_combout\ & (\XALU|Add1~12_combout\)) # (!\XALU|Mux3~4_combout\ & ((\XALU|Add0~12_combout\))))) # (!regOp(1) & (\XALU|Mux3~4_combout\))
...
-- Equation(s):
-- \XALU|Mux3~6_combout\ = (regW(6) & (regOp(1) $ (((regOp(0)) # (regB(6)))))) # (!regW(6) & ((regOp(0) & ((regB(6)) # (regOp(1)))) # (!regOp(0) & (regB(6) & regOp(1)))))
...
\XALU|Mux3~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux3~7_combout\ = (\XALU|Mux3~0_combout\ & ((\XALU|Add2~12_combout\) # ((\XALU|Mux3~1_combout\)))) # (!\XALU|Mux3~0_combout\ & (((!\XALU|Mux3~1_combout\ & \XALU|Mux3~6_combout\))))
...
PORT MAP (
	...
	combout => \XALU|Mux3~7_combout\);

-- Location: LCCOMB_X37_Y13_N2
\XALU|Mux3~8\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux3~8_combout\ = (\XALU|Mux3~1_combout\ & ((\XALU|Mux3~7_combout\ & (\XALU|Add4~12_combout\)) # (!\XALU|Mux3~7_combout\ & ((\XALU|Mux3~5_combout\))))) # (!\XALU|Mux3~1_combout\ & (((\XALU|Mux3~7_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \XALU|Add4~12_combout\,
	datab => \XALU|Mux3~1_combout\,
	datac => \XALU|Mux3~5_combout\,
	datad => \XALU|Mux3~7_combout\,
	combout => \XALU|Mux3~8_combout\);

-- Location: LCCOMB_X37_Y13_N4
\XALU|Mux3~9\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux3~9_combout\ = (\XALU|Mux3~3_combout\) # ((\XALU|Mux3~8_combout\ & ((regOp(2)) # (regOp(3)))))
...
PORT MAP (
	...
	datac => regOp(3),
	datad => \XALU|Mux3~8_combout\,
	combout => \XALU|Mux3~9_combout\);

-- Location: LCCOMB_X37_Y13_N6
\W[6]\ : cycloneii_lcell_comb
-- Equation(s):
-- W(6) = (\rst~combout\ & ((GLOBAL(\estado.resultToW~clkctrl_outclk\) & ((\XALU|Mux3~9_combout\))) # (!GLOBAL(\estado.resultToW~clkctrl_outclk\) & (W(6)))))
...
-- Equation(s):
-- \XALU|Add4~14_combout\ = regB(7) $ (\XALU|Add4~13\ $ (!regW(7)))
...
-- Equation(s):
-- \XALU|Mux2~7_combout\ = (\XALU|Mux3~0_combout\ & ((regOp(0) & ((\XALU|Add4~14_combout\))) # (!regOp(0) & (\XALU|Add2~14_combout\))))
...
-- Equation(s):
-- \XALU|Mux2~9_combout\ = (\XALU|Mux2~7_combout\) # ((\XALU|Mux2~8_combout\ & ((regOp(0)) # (regB(7)))))
...
-- Equation(s):
-- \XALU|Mux2~4_combout\ = (regOp(2) & (!regB(7) & regW(7)))
...
-- Equation(s):
-- \XALU|Mux2~3_combout\ = (regOp(0) & (regOp(3) & (\XALU|Add1~14_combout\ & regOp(1))))
...
-- Equation(s):
-- \XALU|Mux2~5_combout\ = (regOp(3) & (((\XALU|Add0~14_combout\)))) # (!regOp(3) & (!regOp(2) & (regW(6))))
...
PORT MAP (
	...
	datab => regW(6),
	datac => regOp(3),
	datad => \XALU|Add0~14_combout\,
	combout => \XALU|Mux2~5_combout\);

-- Location: LCCOMB_X38_Y12_N20
\XALU|Mux2~6\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux2~6_combout\ = (\XALU|Mux2~3_combout\) # ((\XALU|Mux9~11_combout\ & ((\XALU|Mux2~4_combout\) # (\XALU|Mux2~5_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \XALU|Mux9~11_combout\,
	datab => \XALU|Mux2~4_combout\,
	datac => \XALU|Mux2~3_combout\,
	datad => \XALU|Mux2~5_combout\,
	combout => \XALU|Mux2~6_combout\);

-- Location: LCCOMB_X38_Y11_N14
\XALU|Mux2~10\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux2~10_combout\ = (\XALU|Mux9~10_combout\) # ((\XALU|Mux2~2_combout\) # ((\XALU|Mux2~9_combout\) # (\XALU|Mux2~6_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \XALU|Mux9~10_combout\,
	datab => \XALU|Mux2~2_combout\,
	datac => \XALU|Mux2~9_combout\,
	datad => \XALU|Mux2~6_combout\,
	combout => \XALU|Mux2~10_combout\);

-- Location: LCCOMB_X38_Y11_N22
\W[7]\ : cycloneii_lcell_comb
-- Equation(s):
-- W(7) = (\rst~combout\ & ((GLOBAL(\estado.resultToW~clkctrl_outclk\) & ((\XALU|Mux2~10_combout\))) # (!GLOBAL(\estado.resultToW~clkctrl_outclk\) & (W(7)))))
...
\XALU|Mux0~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux0~1_combout\ = (!regOp(2) & (regOp(1) & !regOp(3)))
...
PORT MAP (
	...
	datac => regOp(1),
	datad => regOp(3),
	combout => \XALU|Mux0~1_combout\);

-- Location: LCCOMB_X38_Y12_N30
\XALU|Mux1~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|Mux1~0_combout\ = (!regOp(2) & regOp(1))
...
-- Equation(s):
-- \XALU|Mux1~1_combout\ = (\XALU|Mux1~0_combout\ & ((regOp(0) & (!\XALU|Add1~16_combout\)) # (!regOp(0) & ((\XALU|Add0~16_combout\)))))
...
PORT MAP (
	dataa => regOp(0),
	datab => \XALU|Mux1~0_combout\,
	datac => \XALU|Add1~16_combout\,
	datad => \XALU|Add0~16_combout\,
	combout => \XALU|Mux1~1_combout\);

-- Location: LCCOMB_X38_Y12_N18
\XALU|preR[8]\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|preR\(8) = (\XALU|Mux0~1_combout\ & (\XALU|preR\(8))) # (!\XALU|Mux0~1_combout\ & ((\XALU|Mux1~1_combout\)))
...
-- Equation(s):
-- \XALU|Mux10~2_combout\ = (\XALU|Mux10~0_combout\) # ((\XALU|Mux0~0_combout\ & (\XALU|Mux10~1_combout\ & regOp(1))))
...
-- Equation(s):
-- \carryOut~0_combout\ = (\rst~combout\ & \estado.resultToW~regout\)
...
-- Location: CLKCTRL_G2
\carryOut~0clkctrl\ : cycloneii_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
-- pragma translate_on
PORT MAP (
	inclk => \carryOut~0clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \carryOut~0clkctrl_outclk\);

-- Location: LCCOMB_X39_Y12_N20
\carryOut$latch\ : cycloneii_lcell_comb
-- Equation(s):
-- \carryOut$latch~combout\ = (GLOBAL(\carryOut~0clkctrl_outclk\) & (\XALU|Mux10~2_combout\)) # (!GLOBAL(\carryOut~0clkctrl_outclk\) & ((\carryOut$latch~combout\)))
...
PORT MAP (
	...
	datac => \carryOut$latch~combout\,
	datad => \carryOut~0clkctrl_outclk\,
	combout => \carryOut$latch~combout\);

-- Location: LCCOMB_X37_Y11_N6
\XALU|LessThan0~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|LessThan0~0_combout\ = (\XALU|Mux4~1_combout\) # ((\XALU|Mux7~7_combout\) # ((!\XALU|Mux0~0_combout\ & \XALU|Mux4~6_combout\)))
...
PORT MAP (
	...
	datac => \XALU|Mux4~1_combout\,
	datad => \XALU|Mux7~7_combout\,
	combout => \XALU|LessThan0~0_combout\);

-- Location: LCCOMB_X38_Y11_N12
\XALU|LessThan0~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|LessThan0~1_combout\ = (\XALU|Mux5~7_combout\) # ((\XALU|Mux2~10_combout\) # ((\XALU|Mux8~7_combout\) # (\XALU|Mux3~9_combout\)))
...
PORT MAP (
	dataa => \XALU|Mux5~7_combout\,
	datab => \XALU|Mux2~10_combout\,
	datac => \XALU|Mux8~7_combout\,
	datad => \XALU|Mux3~9_combout\,
	combout => \XALU|LessThan0~1_combout\);

-- Location: LCCOMB_X38_Y11_N26
\XALU|LessThan0~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|LessThan0~2_combout\ = (\XALU|Mux9~13_combout\) # ((\XALU|LessThan0~0_combout\) # ((\XALU|Mux6~7_combout\) # (\XALU|LessThan0~1_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \XALU|Mux9~13_combout\,
	datab => \XALU|LessThan0~0_combout\,
	datac => \XALU|Mux6~7_combout\,
...
-- Equation(s):
-- \Zout$latch~combout\ = (GLOBAL(\carryOut~0clkctrl_outclk\) & ((!\XALU|LessThan0~2_combout\))) # (!GLOBAL(\carryOut~0clkctrl_outclk\) & (\Zout$latch~combout\))
...
PORT MAP (
	...
	datac => \carryOut~0clkctrl_outclk\,
