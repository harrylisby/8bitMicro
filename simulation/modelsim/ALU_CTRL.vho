...
-- Equation(s):
-- \XALU|Mux6~2_combout\ = (\XALU|Mux6~1_combout\) # ((regOp(0) & (regOp(1) & \XALU|Add1~6_combout\)))
...
-- Equation(s):
-- \XALU|Mux6~4_combout\ = (\XALU|Mux2~1_combout\ & ((\XALU|Mux2~0_combout\) # ((\XALU|Add2~6_combout\)))) # (!\XALU|Mux2~1_combout\ & (!\XALU|Mux2~0_combout\ & (\XALU|Mux6~3_combout\)))
...
-- Equation(s):
-- \XALU|Mux6~6_combout\ = (\XALU|Mux6~0_combout\) # ((\XALU|Mux8~2_combout\) # ((\XALU|Mux6~5_combout\ & !\XALU|Mux2~2_combout\)))
...
-- Equation(s):
-- \XALU|Mux3~3_combout\ = (regOp(0) & (regW(6) $ (regOp(1)))) # (!regOp(0) & (regW(6) & regOp(1)))
...
PORT MAP (
	datab => \rst~combout\,
	datac => \prox_estado.moveToRegisters_588~combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \prox_estado.resultToW_582~combout\,
	datab => \rst~combout\,
...
-- Equation(s):
-- \XROM|Mux2~0_combout\ = (!regAddress(3) & (regAddress(1) & (!regAddress(2) & regAddress(0))))
...
-- Equation(s):
-- \XROM|Mux4~0_combout\ = (!regAddress(3) & (!regAddress(0) & ((regAddress(1)) # (regAddress(2)))))
...
-- Equation(s):
-- \XALU|Mux8~0_combout\ = (!regOp(3) & (!regOp(2) & regOp(1)))
...
-- Equation(s):
-- \XALU|Mux2~5_combout\ = (\XALU|Mux2~4_combout\) # ((regOp(0) & (\XALU|Add1~14_combout\ & regOp(1))))
...
-- Equation(s):
-- \XALU|Add2~0_combout\ = (regW(0) & (\carryIn~combout\ $ (VCC))) # (!regW(0) & (\carryIn~combout\ & VCC))
-- \XALU|Add2~1\ = CARRY((regW(0) & \carryIn~combout\))
...
-- Equation(s):
-- \XALU|Add2~14_combout\ = regW(7) $ (\XALU|Add2~13\)
...
-- Equation(s):
-- \XALU|Mux2~7_combout\ = (\XALU|Mux2~1_combout\ & ((\XALU|Mux2~0_combout\) # ((\XALU|Add2~14_combout\)))) # (!\XALU|Mux2~1_combout\ & (!\XALU|Mux2~0_combout\ & (\XALU|Mux2~6_combout\)))
...
PORT MAP (
	dataa => \XALU|Mux2~1_combout\,
	datab => \XALU|Mux2~0_combout\,
	datac => \XALU|Mux2~6_combout\,
	datad => \XALU|Add2~14_combout\,
...
-- Equation(s):
-- \XALU|Mux2~9_combout\ = (\XALU|Mux2~3_combout\) # ((\XALU|Mux8~2_combout\) # ((!\XALU|Mux2~2_combout\ & \XALU|Mux2~8_combout\)))
...
PORT MAP (
	...
	datab => \XALU|Mux2~3_combout\,
	datac => \XALU|Mux2~8_combout\,
...
-- Equation(s):
-- \XALU|Mux9~2_combout\ = (\XALU|Mux9~1_combout\) # ((\XALU|Add1~0_combout\ & (regOp(1) & regOp(0))))
...
-- Equation(s):
-- \XALU|Mux9~3_combout\ = (regW(0) & (regOp(0) $ (regOp(1)))) # (!regW(0) & (regOp(0) & regOp(1)))
...
-- Equation(s):
-- \XALU|Mux9~4_combout\ = (\XALU|Mux2~1_combout\ & ((\XALU|Add2~0_combout\) # ((\XALU|Mux2~0_combout\)))) # (!\XALU|Mux2~1_combout\ & (((!\XALU|Mux2~0_combout\ & \XALU|Mux9~3_combout\))))
...
-- Equation(s):
-- \XALU|Mux7~3_combout\ = (regW(2) & (regOp(0) $ (regOp(1)))) # (!regW(2) & (regOp(0) & regOp(1)))
...
-- Equation(s):
-- \XALU|Mux7~2_combout\ = (\XALU|Mux7~1_combout\) # ((regOp(1) & (\XALU|Add1~4_combout\ & regOp(0))))
...
-- Equation(s):
-- \XALU|Mux7~4_combout\ = (\XALU|Mux2~0_combout\ & ((\XALU|Mux2~1_combout\) # ((\XALU|Mux7~2_combout\)))) # (!\XALU|Mux2~0_combout\ & (!\XALU|Mux2~1_combout\ & (\XALU|Mux7~3_combout\)))
...
-- Equation(s):
-- \XALU|Mux5~3_combout\ = (regW(4) & (regOp(0) $ (regOp(1)))) # (!regW(4) & (regOp(0) & regOp(1)))
...
-- Equation(s):
-- \XALU|Mux5~2_combout\ = (\XALU|Mux5~1_combout\ & (((\XALU|Add1~8_combout\)) # (!regOp(1)))) # (!\XALU|Mux5~1_combout\ & (regOp(1) & ((\XALU|Add0~8_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \XALU|Mux5~1_combout\,
	datab => regOp(1),
	datac => \XALU|Add1~8_combout\,
...
-- Equation(s):
-- \XALU|Mux5~4_combout\ = (\XALU|Mux2~0_combout\ & ((\XALU|Mux2~1_combout\) # ((\XALU|Mux5~2_combout\)))) # (!\XALU|Mux2~0_combout\ & (!\XALU|Mux2~1_combout\ & (\XALU|Mux5~3_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \XALU|Add2~8_combout\,
	datab => \XALU|Mux2~1_combout\,
	datac => \XALU|Add4~10_combout\,
...
PORT MAP (
	dataa => \XALU|Mux2~2_combout\,
	datab => \XALU|Mux8~2_combout\,
	datac => \XALU|Mux5~5_combout\,
	datad => \XALU|Mux5~0_combout\,
...
-- Equation(s):
-- \XALU|Mux4~3_combout\ = (regOp(0) & (regW(5) $ (regOp(1)))) # (!regOp(0) & (regW(5) & regOp(1)))
...
-- Equation(s):
-- \XALU|Mux4~4_combout\ = (\XALU|Mux2~1_combout\ & ((\XALU|Add2~10_combout\) # ((\XALU|Mux2~0_combout\)))) # (!\XALU|Mux2~1_combout\ & (((!\XALU|Mux2~0_combout\ & \XALU|Mux4~3_combout\))))
...
PORT MAP (
	dataa => \XALU|Mux2~0_combout\,
	datab => \XALU|Add4~12_combout\,
	datac => \XALU|Mux4~4_combout\,
...
-- Equation(s):
-- \XALU|Mux3~2_combout\ = (\XALU|Mux3~1_combout\) # ((regOp(0) & (regOp(1) & \XALU|Add1~12_combout\)))
...
-- Equation(s):
-- \XALU|Mux8~6_combout\ = (\XALU|Mux2~0_combout\ & (\XALU|Mux2~1_combout\)) # (!\XALU|Mux2~0_combout\ & ((\XALU|Mux2~1_combout\ & (\XALU|Add2~2_combout\)) # (!\XALU|Mux2~1_combout\ & ((\XALU|Mux8~5_combout\)))))
...
-- Equation(s):
-- \XALU|Mux8~4_combout\ = (\XALU|Mux8~3_combout\) # ((regOp(1) & (\XALU|Add1~2_combout\ & regOp(0))))
...
PORT MAP (
	...
	datad => \XALU|Mux8~7_combout\,
	combout => \XALU|Mux8~8_combout\);

-- Location: LCCOMB_X44_Y9_N20
\XALU|LessThan0~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \XALU|LessThan0~0_combout\ = (\XALU|Mux6~6_combout\) # ((\XALU|Mux8~8_combout\) # ((\XALU|Mux9~6_combout\) # (\XALU|Mux7~6_combout\)))
...
-- Equation(s):
-- \XALU|LessThan0~1_combout\ = (\XALU|Mux5~6_combout\) # (\XALU|Mux4~6_combout\)
...
-- Equation(s):
-- \XALU|LessThan0~2_combout\ = (\XALU|Mux2~9_combout\) # ((\XALU|Mux3~6_combout\) # ((\XALU|LessThan0~0_combout\) # (\XALU|LessThan0~1_combout\)))
